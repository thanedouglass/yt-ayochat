...
<span class="t-prompt">$</span> python -m scripts.run_agent --query "that footwork transition at 0:15 was insane!"</code></pre>
          ...
          <div class="portal-links">
            ...
            <a href="https://devpost.com/software/yt-shorts-reply-guy" target="_blank" rel="noopener noreferrer" class="portal-btn devpost-btn">
...
<div id="researcher-view" class="glassbox-telemetry-wrapper" role="region" aria-label="Glass Box Telemetry & Study Microscope">
  ...
  <header class="gb-header">
    ...
    <div style="display: flex; align-items: center; gap: 1.5rem;">
      ...
      <a href="https://devpost.com/software/yt-shorts-reply-guy" target="_blank" class="portal-btn" style="padding: 6px 12px; font-size: 0.75rem;">Devpost ↗</a>
    </div>
  </header>
